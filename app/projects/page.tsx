...
const projects = [
  ...
  },
  {
    ...
    description: "A comprehensive mobile ordering solution for Rise'n Roll Bakery",
    period: "2022",
  ...
  },
  {
    ...
    description: "Enterprise financial technology solutions for banks and credit unions",
    period: "2018 - 2022",
    ...
    features: ["Picture pay technology", "Real-time payment processing", "Bank integration systems", "Customer portal"],
  },
  {
    title: "Allied SSO Portal",
    description: "Single Sign-On solution for Allied Payment's enterprise applications",
    period: "2020 - 2022",
    link: "https://sso.alliedpayment.com",
    images: [], // TODO: Add screenshots once provided
    technologies: ["React", "OAuth 2.0", "OpenID Connect", "AWS Cognito"],
    role: "Lead Developer",
    features: ["Single Sign-On", "Multi-factor authentication", "Role-based access control", "User management"],
  },
]
...
const ProjectCard = ({ project }) => {
  ...
  const nextImage = () => {
    setCurrentImageIndex((prev) => (prev === (project.images?.length || 0) - 1 ? 0 : prev + 1))
  }

  const prevImage = () => {
    setCurrentImageIndex((prev) => (prev === 0 ? (project.images?.length || 0) - 1 : prev - 1))
  }
      ...
      <DialogContent className="max-w-4xl">
        <Tabs defaultValue="overview">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                {project.videos.map((video, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-300">Watch Video {index + 1}</span>
                  </a>
                ))}
              </div>
            )}
          ...
          <TabsContent value="features" className="mt-4">
            <h3 className="text-lg font-semibold text-gray-300 mb-4">Key Features</h3>
