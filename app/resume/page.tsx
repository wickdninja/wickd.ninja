...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    logo: "/allied.jpg", // You'll need to add this logo to your public folder
    roles: [
      {
      ...
      },
      {
        ...
        description:
          "Developed features and fixed bugs using ASP.NET MVC 4, C#, JavaScript, and AngularJS.",
    ...
    roles: [
      {
        ...
        location: "Fort Wayne, Indiana",
        description:
          "Built cross-platform mobile expense tracking solution using MongoDB, NodeJS, and React.",
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-32 h-32 bg-gray-800 rounded-full flex items-center justify-center">
        <Building2Icon className="w-20 h-20 text-cyan-400" />
        {/* <img
            ...
            <animated.div style={props}>
              ...
              <div className="flex flex-wrap mt-2">
                {role.skills.map((skill, skillIndex) => (
                  <span
                    key={skillIndex}
                    className="bg-gray-700 text-cyan-400 px-2 py-1 rounded mr-2 mb-2"
                  >
                    {skill}
                  </span>
                ))}
