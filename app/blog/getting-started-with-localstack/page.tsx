    ...
    <div className="min-h-screen bg-gray-900 py-20">
      <div className="max-w-4xl mx-auto px-4">
        <Card className="bg-gray-800/50 backdrop-blur border-cyan-500/20">
          <CardHeader>
            <CardTitle className="text-3xl text-cyan-400">Getting Started with LocalStack</CardTitle>
          ...
          <CardContent>
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                LocalStack is a cloud service emulator that runs in a single container on your local machine. It
                provides an easy-to-use test/mocking framework for developing cloud applications. In this post, we'll
                explore how to set up LocalStack and use it with various AWS services like S3 and SQS, integrating it
                with Node.js applications.
              </p>

              <h2>Setting Up LocalStack with Docker Compose</h2>
              <p>
                Let's start by setting up LocalStack using Docker Compose. Create a file named{" "}
                <code>docker-compose.yml</code> in your project root:
              </p>
...
`}
              ...
              <p>To start LocalStack, run the following command in your terminal:</p>

              <CodeBlock language="bash">{`docker-compose up -d`}</CodeBlock>

              <h2>Setting Up a Node.js Project</h2>
              <p>
                Now, let's set up a Node.js project to interact with LocalStack. First, initialize a new Node.js project
...
AWS_ENDPOINT=http://localhost:4566`}
              ...
              <p>
                Let's create a script to interact with S3 using LocalStack. Create a file named{" "}
                <code>s3-example.js</code>:
              </p>
...
`}
              ...
              <p>
                Now, let's create a script to interact with SQS. Create a file named <code>sqs-example.js</code>:
              </p>
...
`}
              ...
              <p>
                To containerize your Node.js application, create a <code>Dockerfile</code> in your project root:
              </p>
...
docker run --network host -e AWS_ENDPOINT=http://localhost:4566 my-localstack-app`}
              ...
              <p>
                Let's update the <code>docker-compose.yml</code> file to include your Node.js application:
              </p>
...
`}
              ...
              <p>Now you can start both LocalStack and your application with:</p>

              <CodeBlock language="bash">{`docker-compose up --build`}</CodeBlock>

              <h2>Conclusion</h2>
              <p>
                In this guide, we've explored how to set up LocalStack using Docker Compose and how to interact with
                emulated AWS services like S3 and SQS using Node.js. We've also seen how to containerize a Node.js
                application and run it alongside LocalStack.
              </p>
              <p>
                LocalStack is an invaluable tool for local development and testing of AWS-based applications. It allows
                developers to work offline, speeds up the development process, and reduces costs associated with using
                actual AWS services during development and testing phases.
              </p>
              <p>
                As you continue to work with LocalStack, you can explore more AWS services it supports, such as
                DynamoDB, Lambda, API Gateway, and many others. Happy local cloud development!
              </p>
            </div>
          </CardContent>
        </Card>
