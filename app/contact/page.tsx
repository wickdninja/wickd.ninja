      ...
      <div className="max-w-4xl mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Card className="bg-gray-800/50 backdrop-blur border-cyan-500/20">
            <CardHeader>
              <CardTitle className="text-3xl text-cyan-400">Get in Touch</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-200 mb-4">Quick Contact</h3>
                    <div className="space-y-2 text-gray-300">
                      <p>Email: contact@wickd.ninja</p>
                      <p>Location: Remote</p>
                      <p className="text-sm text-gray-400 mt-4">
                        Prefer CLI? Try running:
                        <code className="block mt-2 p-2 bg-gray-700 rounded">npx wickdninja</code>
                      </p>
                    </div>
                  </div>
                </div>
